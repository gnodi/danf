...
LinkFollower.defineDependency('_reloadingSequence', 'danf:sequencing.sequence');
 ...
 */
LinkFollower.prototype.follow = function(event) {
    var $ = this._jquery,
        link = $(event.currentTarget || event.target)
    ;
 ...
 * @interface {danf:ajaxApp.formSubmitter}
 */
LinkFollower.prototype.write = function(content, url, event) {
    var $ = this._jquery,
        link = event.target
    ;
