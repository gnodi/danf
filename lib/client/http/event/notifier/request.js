...
Request.prototype.notifyEvent = function(name, parameters, sequence, data) {
    ...
    $.ajax(settings)
        .done(function(data, textStatus, jqXHR) {
            ...
            executeSequence(sequence, 'done', data, jqXHR);
        })
        .fail(function(jqXHR, textStatus, errorThrown) {
            ...
            executeSequence(sequence, 'fail', {}, jqXHR);
        })
        .always(function(data, textStatus, jqXHR) {
            executeSequence(sequence, 'always', data, jqXHR);
        })
    ;
}
 ...
 * @param {object} state The data.
 * @param {object} state The XHR request object.
 * @api private
 */
var executeSequence = function(sequence, state, data, jqXHR) {
