...
Request.defineDependency('_history', 'danf:manipulation.history');
 ...
 * @api public
 */
Object.defineProperty(Request.prototype, 'history', {
    ...
    this.__asyncProcess(function(returnAsync) {
        $.ajax(settings)
            .done(function(data, textStatus, jqXHR) {
                self._logger.log(
                    'Request [{0}]"{1}" succeeded: {3}'.format(
                        settings.method,
                        settings.url,
                ...
                executeSequence.call(self, sequence, parameters, 'done', data, jqXHR, request, returnAsync);
            })
            .fail(function(jqXHR, textStatus, errorThrown) {
                ...
                executeSequence.call(self, sequence, parameters, 'fail', {}, jqXHR, request, returnAsync);
            })
            .always(function(data, textStatus, jqXHR) {
                executeSequence.call(self, sequence, parameters, 'always', data, jqXHR, request, returnAsync);
            })
        ;
    });
}
