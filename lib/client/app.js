...
define(function(require) {
    ...
    for (var i = 0; i < context.modules.length; i++) {
        ...
        switch (moduleId) {
            case 'ajax-app':
                requiredModules.push('danf/config/ajax-app/client/classes');
            ...
            case 'configuration':
                ...
                requiredModules.push('danf/config/configuration/client/classes');
            ...
            case 'dependency-injection':
                ...
                requiredModules.push('danf/config/dependency-injection/client/classes');

                break;
            case 'event':
                requiredModules.push('danf/config/event/interfaces');
                requiredModules.push('danf/config/event/services');
                requiredModules.push('danf/config/event/client/classes');
            ...
            case 'manipulation':
                ...
                requiredModules.push('danf/config/manipulation/client/classes');

                break;
            case 'object':
                requiredModules.push('danf/config/object/interfaces');
                requiredModules.push('danf/config/object/services');
                requiredModules.push('danf/config/object/client/classes');

                break;
            case 'http':
                requiredModules.push('danf/config/http/interfaces');
                requiredModules.push('danf/config/http/client/classes');
                requiredModules.push('danf/config/http/client/services');

            case 'vendor':
                requiredModules.push('danf/config/vendor/client/classes');
