...
Object.defineProperty(CollectionInterpreter.prototype, 'asynchronousCollections', {
    set: function(asynchronousCollections) {
        for (var i in asynchronousCollections) {
            ...
            this.setCollectionInterpreter(asynchronousCollection.method, asynchronousCollection);
        }
    }
});
 ...
 * @api public
 */
CollectionInterpreter.prototype.setCollectionInterpreter = function(method, asynchronousCollection) {
