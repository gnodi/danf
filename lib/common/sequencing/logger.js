 ...
 */
Logger.prototype.log = function(message, verbosity, indentation, tributary, level, startedAt, maxLength) {
    ...
    this._logger.log(displayedMessage, verbosity, 0, maxLength ? maxLength : 200);
}