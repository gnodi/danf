...
console.log('..', tributaryData.stream, tributaryData.scope);
            ...
            if (undefined !== tributaryData.parent) {
                ...
                if (tributaryData.scope) {
                    ...
                    for (var i = 0; i < scopePaths.length; i++) {
                        var scopePath = scopePaths[i];console.log('!', scopePath, scopePaths);

                        if (i === scopePaths.length - 1) {console.log(5);
                            stream[scopePath] = tributaryData.stream;
                        } else if ('object' !== typeof stream[scopePath]) {console.log(6);
                            stream[scopePath] = {};
                        }
...
console.log(7);
                ...
                if (tributaryData.callback) {console.log('__', tributaryData.stream, tributaryData.scope, this._mainStream);
                ...
                if (tributaryData.callback) {console.log('--', tributaryData.stream, tributaryData.scope);
                    tributaryData.callback();
                }
            }
