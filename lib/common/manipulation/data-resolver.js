...
/**
 * Set the data interpreters.
 *
 * @param {danf:manipulation.dataInterpreter_array}
 * @api public
 */
 ...
 */
DataResolver.prototype.merge = function(data1, data2, contract, erase, namespace, parameters, formatsContrat) {
    return mergeData.call(
        this,
        namespace ? namespace : '',
        data1,
        data2,
        formatsContrat === false ? contract : formatContract.call(this, contract),
        erase,
        parameters || {}
    );
}
 ...
 * @interface {danf:manipulation.dataResolver}
 */
DataResolver.prototype.resolve = function(data, contract, namespace, parameters, formatsContrat) {
