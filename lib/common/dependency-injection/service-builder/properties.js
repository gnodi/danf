...
var resolveServiceReference = function(definition, instance, source, property, index, resolveRegistries) {
    ...
    if (serviceReference) {
        ...
        if (
            ...
            (resolveRegistries && undefined === serviceItem)
        ) {
            return source;
        }
        ...
        if (undefined !== serviceItem) {
            ...
            if (serviceDefinition.registry.namespace) {
                ...
                serviceItem = this._namespacer.prefix(serviceItem, module, this._modulesTree);
            }

            object = service[serviceDefinition.registry.method](serviceItem);
        }
