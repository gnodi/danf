 ...
 * @api public
 */
Object.defineProperty(ServicesContainer.prototype, 'referenceResolver', {
...
ServicesContainer.prototype.handleRegistryChange = function(items, reset, name) {
    ...
    if (!reset) {
        ...
        // Define.
        for (var id in this._definitions) {
            this._definitions[id] = resolve.call(this, this._definitions[id]);
        }
        for (var id in this._definitions) {
...
ServicesContainer.prototype.setDefinition = function(id, definition) {
    ...
    if (!this._definitions[id]) {
        this._definitions[id] = resolve.call(this, definition);
    }
    this._definitions[id] = define.call(this, this._definitions[id]);
}
 ...
 * @return {object} The resolved definition.
 * @api private
 */
var resolve = function(definition) {
    definition = this._referenceResolver.resolve(
        definition,
        '$',
        this.config,
    ...
    for (var i = 0; i < this._serviceDefiners.length; i++) {
        definition = this._serviceDefiners[i].resolve(definition);
    }
