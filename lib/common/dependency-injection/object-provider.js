...
ObjectProvider.prototype.provide = function(properties) {
    ...
    object.__metadata = {
        id: 'an instance of {0}'.format(this._class.__metadata.id),
        class: this._class.__metadata.id,
        module: this._class.module,
        implements: this._class.__metadata.implements || [],
        dependencies: this._class.__metadata.dependencies || {}
    };
