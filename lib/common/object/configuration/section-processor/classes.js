...
Classes.prototype.interpretModuleConfig = function(config, module, modulesTree) {
    for (var className in config) {
        ...
        if (class_.__metadata.extends) {
            ...
            var prototype = Object.getPrototypeOf(class_.prototype);

            if (prototype.__reference) {
                prototype.__reference = this._namespacer.prefix(prototype.__reference, module, modulesTree);
            }
        }
