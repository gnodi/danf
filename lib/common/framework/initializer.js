...
var utils = require('../utils'),
    ...
    InducedServiceBuilder = require('../dependency-injection/service-builder/induced'),
    ...
    Flow = require('../manipulation/flow')
;
...
Initializer.prototype.instantiate = function(framework) {
    ...
    framework.set('danf:dependencyInjection.serviceBuilder.induced', new InducedServiceBuilder());
    ...
    ;
    framework.set('danf:manipulation.flowProvider', flowProvider);
}
...
Initializer.prototype.inject = function(framework, parameters) {
    ...
    var servicesContainer = framework.get('danf:dependencyInjection.servicesContainer'),
        ...
        inducedServiceBuilder = framework.get('danf:dependencyInjection.serviceBuilder.induced')
    ;
