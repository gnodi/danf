...
if (!module.isClient) {
    ...
    NamespacesDataInterpreter = require('../configuration/manipulation/data-interpreter/namespaces');
...
define(function(require) {
     ...
     */
     if (module.isClient) {
        utils = require('-/danf/lib/common/utils');
        ...
        ParametersConfigurationSectionProcessor = require('-/danf/lib/common/configuration/section-processor/parameters');
        ServicesConfigurationSectionProcessor = require('-/danf/lib/common/dependency-injection/configuration/section-processor/services');
        ...
        ReferencesDataInterpreter = require('-/danf/lib/common/configuration/manipulation/data-interpreter/references');
        NamespacesDataInterpreter = require('-/danf/lib/common/configuration/manipulation/data-interpreter/namespaces');
