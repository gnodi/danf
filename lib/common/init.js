                ...
                if (withValue && -1 === typeName.indexOf('instance')) {
                    try {
                        ...
                        if (stringValue.length > 1000) {
                            stringValue = stringValue.substr(0, 1000) + '...';
                        }
                    } catch (error) {}
                }
...
if (!Function.getReference) {
    /**
     * Get a reference to another function/class.
     *
     * @param {string} name The name.
     * @return {function} The reference function.
     */
    Function.getReference = function(name) {
        var construct,
            Reference = function() {
                if (construct) {
        ...
        Object.defineProperty(Reference.prototype, '__reference', {
            set: function(value) { name = value; },
            get: function() { return name; }
        });

        Object.defineProperty(Reference.prototype, '__construct', {
            set: function(value) { construct = value; },
            get: function() { return construct; }
        });
    ...
    Object.checkDependencies = function(object) {
        ...
        for (var property in object.__metadata.dependencies) {
            ...
            try {
                ...
                if (error.instead) {
                    error.message = 'The object{0} expected {1} for its property "{2}"; {3} given instead.'.format(
                        id,
                        error.expected,
                        property,
                        error.instead
