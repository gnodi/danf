...
define(function(require) {
     ...
     * @interface {danf:dependencyInjection.serviceBuilder}
     */
    Declinations.prototype.merge = function(parent, child) {
        if (null == child.declinations) {
            child.declinations = parent.declinations;
        }
        if (null == child.key) {
            child.key = parent.key;
        }
        if (null == child.declinationParent) {
            child.declinationParent = parent.declinationParent;
        }
