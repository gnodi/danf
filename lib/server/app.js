 ...
 * @param {object|string|null} clientConfiguration The danf client configuration.
            ...
            app.listenHttp = function(end) {
                ...
                if (isSocketServer) {
                    ...
                    app.io.use(function(socket, next) {
                        sessionMiddeware(socket.request, socket.request.res, next);
                    });
                }
