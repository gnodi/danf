...
function AppBuilder(serverConfiguration, clientConfiguration, serverContext, clientContext) {
    ...
    this._paths.appAbsolute = require.main.filename.indexOf('/gulp/') === -1
...
AppBuilder.prototype.buildServer = function(done) {
    ...
    // Process master.
    if (cluster.isMaster && context.clustered) {
         ...
         *
         * @param {function} end An optionnal callback to be call at the end of listening.
         * @api public
         */
